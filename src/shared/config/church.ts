...
export const ministries: IconCard[] = [
  ...
  },
  {
    ...
    text: "Подготовка команд, регистрация участников и отчеты будут вынесены в отдельную user-панель.",
  },
];
